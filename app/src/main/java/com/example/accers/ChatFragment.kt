...
class ChatFragment : Fragment() {
    ...
    private val botList = listOf("Intensity AI", "Intensity AI", "Intensity AI","Intensity AI","Intensity AI","Intensity AI")
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        customBotMessage("Hello! Today you're speaking with ${botList[random]}, just type help to see what i can do ")
    }
        ...
        GlobalScope.launch {
            ...
            withContext(Dispatchers.Main) {
                ...
                when (response) {
                    ...
                    "OPEN_CALCULATOR" -> {
                        val site = Intent(Intent.ACTION_VIEW)
                        site.data = Uri.parse("https://www.calculator.net/calories-burned-calculator.html")
                        startActivity(site)
                    }
